...
*/
    ...
    // Create a list to store the selected seats
    List<String> selectedSeats = new ArrayList<>();

    // Check which radio buttons are selected and add them to the list
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mtrs", "root", "8008");
         ...
         ResultSet rs = stmt.executeQuery("SELECT title FROM movies ORDER BY movieId DESC LIMIT 1;")) {
        if (rs.next()) {
    ...
    // Create a new instance of the billing form and pass the selected seats and movie data
    billing billingForm = new billing();
    billingForm.setData(movie, selectedSeats);
    billingForm.setVisible(true);

    // Close the seats form
    this.dispose();
}
